...
if __name__ == "__main__":
    ...
    model = MLPClassifier(hidden_layer_sizes=(584, 256, 256))
    ...
    print(conf_matrix)
    if 0.6 < acc < 0.7:
        joblib.dump(model, f'official_test/gesture_model_584 512 512_{model.score(x_test, y_test):}.pkl')
    utils.plot_confusion_matrix(conf_matrix, to_show=False)
